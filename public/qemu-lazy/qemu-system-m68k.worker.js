...
function handleMessage(e) {
  try {
    ...
    self.startWorker = (instance) => {
      ...
      (e.data.urlOrBlob ? import(e.data.urlOrBlob) : import('./qemu-system-m68k'))
      .then(exports => exports.default(Module));
    } else if (e.data.cmd === 'run') {
      // Pass the thread address to wasm to store it for fast access.
      Module['__emscripten_thread_init'](e.data.pthread_ptr, /*is_main=*/0, /*is_runtime=*/0, /*can_block=*/1, /*default_stacksize=*/65536, /*start_profiling=*/false);
